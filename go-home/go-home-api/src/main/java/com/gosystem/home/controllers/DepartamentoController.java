...
public class DepartamentoController {
	...
	public DepartamentoController() {
		this.logger = UtilsLogs.getLogger(DepartamentoController.class.getName());
	}
	...
	public ResponseEntity<Object> guardar(@RequestBody DepartamentoDTO json, HttpServletRequest req) {	
		logger.info(nameApp + " guardar :: INICIO ");
		logger.info(nameApp + " Request ::  " + UtilGson.SerializeObjet( json));
		try {
			//departamentoService.save(json);
	...
	public ResponseEntity<Object> editar(@RequestBody DepartamentoDTO json, HttpServletRequest req) {
		logger.info(nameApp + " Editar :: INICIO ");	
		logger.info(nameApp + " Request ::  " + UtilGson.SerializeObjet( json));
		try {
			//departamentoService.edith(json);
	...
	public ResponseEntity<Object> consultarAll() {
		...
		List<DepartamentoDTO> list =   this.ubicacionService.getAllDepartamentos();
	...
	public ResponseEntity<Object> consultarbyId(@PathVariable Long id) {
		...
		try {
			// DepartamentoDTO d =  departamentoService.getByid(id);
			return new ResponseEntity<Object>(null, HttpStatus.OK);		
		}catch (ParametrizacionException e) {
			logger.severe(e.getMessage());
			return new ResponseEntity<Object>(e.getMessage(), HttpStatus.BAD_REQUEST);

...
private Logger logger;
	...
	public ResponseEntity<Object> delete(@RequestBody UsuarioDTO usuario, HttpServletRequest req) {
	...
	public ResponseEntity<Object> desactivate(@RequestBody UsuarioDTO usuario, HttpServletRequest req) {
